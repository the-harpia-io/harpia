...
INSERT INTO `environments` VALUES
    ( 1, 'Unassigned', '{\"description\": \"Notifications without Environments will be here\", \"default_scenario\": \"\"}', '{\"visible_only\": [], \"hidden\": []}', '2021-03-07 21:54:27', '2021-03-07 21:54:27' ),
...
INSERT INTO `scenarios` VALUES ( 1, 'Unassigned', NULL, 'Scenario description', '', 'The reason of creating it', '[]', 1, NULL, 'admin', '[{"execute_after_seconds": 0, "action_trigger_delay": "0s", "type": "ui", "body": {"recipients": ["List of people who should be notified"], "description": "Info about scenario", "affected_func": "What was affected", "should_check": ["what operator should check"], "players_expirience": "What is the user experience if alert appear", "not_handled_effects": "What will be affected if alert won`t be handled", "notification_period": {}, "action_name": "Which action should be done to fix the problem"}}]', '2021-04-26 13:27:55', '2021-04-26 13:27:55' );
